...
class ScatteredBallsPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final circles = [
      ...
      Circle(const Offset(150, 550), 20, const Color.fromRGBO(185, 246, 202, 1),),

      Circle(const Offset(350, 80), 27, const Color.fromRGBO(185, 246, 202, 1),),
      Circle(const Offset(120, 200), 12, const Color.fromRGBO(185, 246, 202, 1),),
      Circle(const Offset(290, 250), 22, const Color.fromRGBO(185, 246, 202, 1),),
      Circle(const Offset(50, 500), 15, const Color.fromRGBO(185, 246, 202, 1),),
      Circle(const Offset(280, 350), 29, const Color.fromRGBO(185, 246, 202, 1),),

      Circle(const Offset(300, 500), 14, const Color.fromRGBO(185, 246, 202, 1),),
